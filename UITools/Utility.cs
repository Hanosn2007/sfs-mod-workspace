...
// ReSharper disable once InconsistentNaming
    ...
    public static class UIUtility
    {
        ...
        public static Texture2D CreateTexture(string base64Image)
        {
            ...
            System.Type imageConversion = System.Type.GetType("UnityEngine.ImageConversion, UnityEngine.ImageConversionModule");
            MethodInfo loadImage = imageConversion?.GetMethod("LoadImage", new[] { typeof(Texture2D), typeof(byte[]) });
            loadImage?.Invoke(null, new object[] { result, data });
            result.Apply();
            return result;
        }
    }
