...
namespace BuildSettings
{
    ...
    public class BS_Keybindings : ModKeybindings
    {
        ...
        {
            AddBuildKeyDown(main.CustomRotate[0], () => GUI.CustomRotate(true));
            AddBuildKeyDown(main.CustomRotate[1], () => GUI.CustomRotate());
            AddBuildKeyDown(main.Movement[0], () => MoveSelectedParts(PartMoveDirection.Down));
            AddBuildKeyDown(main.Movement[1], () => MoveSelectedParts(PartMoveDirection.Up));
            AddBuildKeyDown(main.Movement[2], () => MoveSelectedParts(PartMoveDirection.Left));
            AddBuildKeyDown(main.Movement[3], () => MoveSelectedParts(PartMoveDirection.Right));
            AddBuildKeyDown(main.ChangeWidth[0], () => ResizeSelectedParts(PartResizeType.DecreaseWidth));
            AddBuildKeyDown(main.ChangeWidth[1], () => ResizeSelectedParts(PartResizeType.IncreaseWidth));
            AddBuildKeyDown(main.ChangeHeight[0], () => ResizeSelectedParts(PartResizeType.DecreaseHeight));
            AddBuildKeyDown(main.ChangeHeight[1], () => ResizeSelectedParts(PartResizeType.IncreaseHeight));
            AddBuildKeyDown(main.ChangeValues[0], SetValues.SetSmallMove);
            AddBuildKeyDown(main.ChangeValues[1], SetValues.SetSmallResize);
            AddBuildKeyDown(main.Modifier, () =>
            {
            ...
            AddBuildKeyDown(main.OrientationMode, () =>
            {
            ...
            AddBuildKeyDown(main.ToggleInfiniteArea, () =>
            {
            ...
            AddBuildKeyDown(main.TogglePartClipping, () =>
            {
                if (!Base.worldBase.AllowsCheats)
                {
                    SoundPlayer.main.denySound.Play();
        ...
        private static void AddBuildKeyDown(Key key, Action action)
        {
            AddOnKeyDown_Build(key, () =>
            {
