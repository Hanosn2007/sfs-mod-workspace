...
namespace PartEditor
{
    ...
    public static class ConfigGUI
    {
        ...
        static GameObject CreateConfigGUI(Transform parent)
        {
            ...
            Builder.CreateSlider(widthContainer, (size.x - 70) / 2, Config.settings.windowSize.Value.x / 10f, (40, 60),
                true,
            ...
            Builder.CreateSlider(heightContainer, (size.x - 70) / 2, Config.settings.windowSize.Value.y / 10f, (55, 80),
                true,
